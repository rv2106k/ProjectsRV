...
public class Transactions extends JFrame implements ActionListener {
    JButton deposit, cashwithdrawl, fastcash, ministatement, pinchange, balanceenguiry, exit;
    String pinnumber;
    Transactions(String pinnumber) {
        ...
        cashwithdrawl.setBounds(355, 350, 150, 30);
        ...
        balanceenguiry = new JButton("Balance Enquiry");
        balanceenguiry.setBounds(355, 450, 150, 30);
    ...
    public void actionPerformed(java.awt.event.ActionEvent ae) {
        ...
        } else if (ae.getSource() == balanceenguiry) {
            setVisible(false);
